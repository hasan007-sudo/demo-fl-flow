// ABOUTME: Header component for the landing page
// ABOUTME: Displays logo, navigation links, and theme toggle
...
export default function Header() {
  ...
  return (
    <header className="flex justify-between items-center px-6 py-4 max-w-4xl mx-auto bg-white dark:bg-gray-900 transition-colors">
