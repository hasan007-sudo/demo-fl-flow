// ABOUTME: Landing page component for Learning Forever
// ABOUTME: Displays hero section, features, pricing plans, and services
              ...
              <ul className="space-y-3">
                {features[0].bullets.map((bullet, bulletIndex) => (
                  <li
                    ...
                    style={{ transitionDelay: `${bulletIndex * 150}ms` }}
                  >
